...
```{r}
git rename 01-preprocessing.do 01a-preprocessing_mainform.do # rename without move or
git rename 01-prepcoressing.do ./01-code/01-prepcoressing.do # ... only moving, not renaming
```
